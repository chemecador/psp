...
public class Cliente {
    ...
    public Cliente() {
        try {
            ...
            //leer pregunta user o admin, descifrar con la librería Cifrado
    ...
    private void adminComprobacion() throws IOException {
        //envía al servidor su petición de logearse como administrador, cifrada con la librería Cifrado
    ...
    private void userComprobacion() throws IOException {
        //envía al servidor un mensaje con su Tipo de Usuario (usuario), cifrada con la librería Cifrado
        m.setS(this.tu.toString());
        m.setTu(this.tu);
        json = gson.toJson(m);
        out.writeUTF(c.cifrar(json));
        ...
        do {
            //leer el mensaje, descifrado con librería Cifrado
            s = c.descifrar(in.readUTF());
            m = gson.fromJson(s, Mensaje.class);
            s = m.getS();
            System.out.println(s);
            //leer de teclado y enviar, cifrado con la librería Cifrado
            s = sc.nextLine();
            m.setS(s);
            json = gson.toJson(m);
            out.writeUTF(c.cifrar(json));
