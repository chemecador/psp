...
public class Cliente {
    ...
    public Cliente() {
        ...
        try {
            ...
            while (true) {
                // leemos en pantalla el mensaje recibido y lo desciframos con la librería Cifrado
                ...
                json = gson.toJson(m);
                //se lo enviamos al servidor en formato json, cifrado con la librería Cifrado
                out.writeUTF(c.cifrar(json));
                //leemos la respuesta del servidor y lo desciframos con la librería Cifrado
                s = c.descifrar(in.readUTF());
                //guardamos en la variable Mensaje m el contenido del json (String s) gracias al método fromJson de la librería gson
                m = gson.fromJson(s, Mensaje.class);
                //lo mostramos por pantalla
